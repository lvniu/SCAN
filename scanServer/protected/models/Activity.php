...
class Activity extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('telephone, activity_name, start_time, end_time, location, goods', 'required', 'message'=>'必填'),
			...
			array('id, username, company_name, activity_name, telephone, start_time, end_time, location, goods, time_remaining, relative_distance', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('time_remaining',$this->time_remaining,true);
		$criteria->compare('relative_distance',$this->relative_distance,true);
